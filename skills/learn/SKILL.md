...
adaptation: moderate
upstream_url: https://github.com/hugosantanna/clo-author/blob/24abd60ba532ee8db11b6b13e46595587258c1ca/.claude/skills/learn/SKILL.md
...
Create the skill file at `.claude/skills/[skill-name]/SKILL.md` (project) or
`~/.claude/skills/[skill-name]/SKILL.md` (global, if useful across all projects):
...
author: [read from private/profile.md — never hardcode a name here]
version: 1.0.0
